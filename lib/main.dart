  ...
  void _calulate() {
    setState(() {
      ...
      if (imc < 18.6) {
        ...
        _infoText = "Obesidade I grau (${imc.toStringAsPrecision(3)})";
      } else if (imc >= 34.9 && imc < 39.9) {
        _infoText = "Obesidade II grau (${imc.toStringAsPrecision(3)}))";
      } else if (imc >= 40.0) {
        _infoText = "Obesidade III grau (${imc.toStringAsPrecision(3)})";
      }
    });
  }
